...
public class WriteFile {
    ...
    public static void main(String[] args) {
        for (int i = 0; i < 20; i++) {
            System.out.println(getFileName("C:\\Users\\DCV\\Desktop\\", "Hello World", i, ".txt"));
        }
        try {
...
//          File myFile = new File("C:\\Users\\DCV\\Desktop\\Hello World.txt");
            ...
            for (int i = 1; i < 7; i++) {
                File myFile = new File(getFileName("C:\\Users\\DCV\\Desktop\\", "Hello World", i, ".txt"));

                while (myFile.isFile() && myFile.exists()) {
                    System.out.println(myFile + "already exists.");
                }
                FileWriter myWriter = new FileWriter(getFileName("C:\\Users\\DCV\\Desktop\\", "Hello World", i, ".txt"));
