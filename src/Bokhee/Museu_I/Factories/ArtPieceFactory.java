...
import Bokhee.Museu_I.ArtPiece;
...
public class ArtPieceFactory {
    ...
    private static Date startDate = new Date(-11676096000L); // 1. Jan. 1600
    private static Date endDate = new Date(1577836800L); // 1.Jan. 2020
