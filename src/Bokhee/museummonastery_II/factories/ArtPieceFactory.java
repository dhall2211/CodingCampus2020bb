package Bokhee.museummonastery_II.factories;

import Bokhee.museummonastery_II.ArtPiece;
...
public class ArtPieceFactory {
    ...
    public static LinkedList<ArtPiece> createArtPiece(int count) {
        LinkedList<ArtPiece> artPieces = new LinkedList<ArtPiece>();
    ...
    public static ArtPiece createArtPiece() {
            ...
            Date createdDate = getRandomDate(startDate, endDate);
            Integer price = 100 + random.nextInt(900);
            ArtPiece newOneArtPiece = new ArtPiece(type, title, artist, createdDate, price);

        return newOneArtPiece;
    }
