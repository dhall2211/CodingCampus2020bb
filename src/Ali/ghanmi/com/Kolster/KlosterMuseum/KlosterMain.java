...
10. Kurator Klasse und die Simulation
    ...
    public static void main(String[] args) {
        ...
        Visitor Fritz =new Visitor("fritz","Au",15);
        Visitor frank =new Visitor("frank","Lustena",45);
        Visitor fred =new Visitor("fred","Bregenz",65);
        Visitor frederich =new Visitor("Lustena","Au",70);
        Visitor ma =new Visitor("ma","Bregenz",77);
        Visitor lea =new Visitor("lea","Bregenz",18);
        Visitor leonardo =new Visitor("leonardo","Lustena",102);
        Visitor selly =new Visitor("selly","Au",12);
        Visitor sonia =new Visitor("sonia","Feldkirch",5);
        Visitor sandra =new Visitor("sandra","Lustena",61);
        Visitor katy =new Visitor("katy","Bregenz",66);
        Visitor kate =new Visitor("kate","Feldkirch",44);
        Visitor diana =new Visitor("diana","Au",39);
...
/*
        ...
        room100.addVisitorToRoom(ma);
        room100.addVisitorToRoom(lea);
        room200.addVisitorToRoom(Fritz);
        room200.addVisitorToRoom(frank);

        room300.addVisitorToRoom(fred);
        room300.addVisitorToRoom(leonardo);
        room300.addVisitorToRoom(kate);
        room300.addVisitorToRoom(katy);

        room400.addVisitorToRoom(frederich);
        room400.addVisitorToRoom(sandra);
        room400.addVisitorToRoom(selly);
        room400.addVisitorToRoom(sonia);
